...
- [1. ABP应用层 - 数据传输对象](#1-abp)
    - [1.1. 目录](#11)
    - [1.2. 数据传输对象的作用](#12)
        - [1.2.1. 抽象领域层 (Abstraction of domain layer)](#121--abstraction-of-domain-layer)
        - [1.2.2. 数据隐藏 (Data hiding)](#122--data-hiding)
        - [1.2.3. 序列化 & 懒加载 (Serialization & lazy load problems)](#123---serialization-lazy-load-problems)
    - [1.3. DTO 约定 & 验证](#13-dto)
    - [1.4. DTO和实体间的自动映射](#14-dto)
        - [1.4.1. 使用特性(attributes)和扩展方法来映射](#141-attributes)
    - [1.5. 辅助接口和类型](#15)
...
### 1.2.1. 抽象领域层 (Abstraction of domain layer)
...
### 1.2.3. 序列化 & 懒加载 (Serialization & lazy load problems)
...
### 1.4.1. 使用特性(attributes)和扩展方法来映射
