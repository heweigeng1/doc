...
- [1. ABP领域层 - 数据过滤器](#1-abp)
    - [目录](#)
    - [1.1. 简介](#11)
    - [1.2. 预定义过滤器](#12)
        - [1.2.1. 逻辑除接口(ISoftDelete)](#121-isoftdelete)
        - [1.2.2. 多租接口(IMustHaveTenant)](#122-imusthavetenant)
        - [1.2.3. 多租接口(IMayHaveTenant)](#123-imayhavetenant)
    - [1.3. 禁用过滤器](#13)
    - [1.4. 全局性禁用过滤器](#14)
    - [1.5. 启用过滤器](#15)
    - [1.6. 设定过滤器参数](#16)
        - [1.6.1. SetTenantId方法](#161-settenantid)
    - [1.7. ORM集成](#17-orm)
        - [1.7.1. 自定义过滤器](#171)
    - [1.8. 其它对象关系映射工具](#18)
...
>EntityFramework.DynamicFilters的文件:若需要更多关于动态数据过滤器的相关信息,可以见其在git上的[文件](https://github.com/jcachat/EntityFramework.DynamicFilters)
